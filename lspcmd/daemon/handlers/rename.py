...
from ..rpc import RenameParams, RenameResult
from ...utils.text import read_file_content
from ...utils.uri import uri_to_path
from .base import HandlerContext


async def handle_rename(ctx: HandlerContext, params: RenameParams) -> RenameResult:
...
async def _apply_workspace_edit(
    ctx: HandlerContext, edit: dict, workspace_root: Path
) -> list[str]:
